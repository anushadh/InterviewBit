package javaproblems.priorityQueueComparator;
...
class Main {
    public static void main(String[] args) throws IOException{
        ...
        //PriorityQueue<Integer> myPD = new PriorityQueue<>(Collections.reverseOrder());
        PriorityQueue<Integer> myPD = new PriorityQueue<>(Comparator.reverseOrder());
